...
data class SettingsUiState(
    ...
    val editingField: String? = null, // "lateFee", "monthlyFee", "gracePeriod", "dueDate", "assocName", "assocAddress", "assocPhone", "printFormat"
        ...
        viewModelScope.launch {
            try {
                repository.updateSettings(
                    lateFee, monthlyFee, gracePeriod, dueDays,
                    assocName, assocAddress, assocPhone, format, logo
                )
            } catch (e: Exception) {
